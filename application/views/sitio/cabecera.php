...
<head>
    ...
    <link rel="stylesheet" href="//cdn.datatables.net/select/1.5.0/js/select.bulma.min.js" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/template/sitio/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/template/sitio/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/template/sitio/css/jquery-ui.min.css" type="text/css">
